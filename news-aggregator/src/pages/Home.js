    ...
    const fetchArticles = async () => {
      ...
      try {
        if (filters.source === "newsapi") {
          ...
          const newsArticles = await fetchNewsAPIArticles(filters.query, filters.date, filters.category, page);
          const guardianArticles = await fetchGuardianArticles(filters.query, filters.date, filters.category, page);
          const nyTimesArticles = await fetchNYTimesArticles(filters.query, filters.date, filters.category, page);
